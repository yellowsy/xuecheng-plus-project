...
public class MediaFileServiceImpl implements MediaFileService {
    ...
    public boolean addMediaFilesToMinIO(String localFilePath,String mimeType,String bucket, String objectName){
        try {
            ...
            log.debug("上传文件到minio成功,bucket:{},objectName:{},成功信息:{}",bucket,objectName);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @Override
    public UploadFileResultDto uploadFile(Long companyId, UploadFileParamsDto uploadFileParamsDto, String loadFilePath,String objectName) {
        //文件名
        ...
        //1.上传到Minio
        boolean result = addMediaFilesToMinIO(loadFilePath, mimeType, bucket_mediafiles, objectName);
        if(!result){
    ...
    public RestResponse uploadChunk(String fileMd5, int chunk, String localChunkFilePath) {
        ...
        boolean isSuccess = addMediaFilesToMinIO(localChunkFilePath, mimeType, bucket_video, chunkFilePath);
        if(!isSuccess){
    ...
    public File downloadFileFromMinIO(String bucket,String objectName){
        ...
        try{
            InputStream stream = minioClient.getObject(GetObjectArgs.builder()
                    ...
                    .build());
            //创建临时文件
            minioFile=File.createTempFile("minio", ".merge",new File("D:\\Project\\SpringCloud\\XuCheng\\upload\\temp"));
