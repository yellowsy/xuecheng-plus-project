...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "D:\\Project\\SpringCloud\\XuCheng\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "D:\\Project\\SpringCloud\\XuCheng\\upload\\1.avi";
    String mp4_name = "1.mp4";
    String mp4folder_path = "D:\\Project\\SpringCloud\\XuCheng\\upload\\1.mp4";
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String ffmpeg_path = "D:\\Project\\SpringCloud\\XuCheng\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\Project\\SpringCloud\\XuCheng\\upload\\1.mp4";
        //转换后mp4文件的名称
        String mp4_name = "1.avi";
        //转换后mp4文件的路径
        String mp4_path = "D:\\Project\\SpringCloud\\XuCheng\\upload\\1.avi";
        //创建工具类对象
